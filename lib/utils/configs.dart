...
const APP_NAME = 'Ezzyrock';
const APP_NAME_TAG_LINE = 'On-Demand E-commerce Classified App';
var defaultPrimaryColor = Color(0xFF0866CF);

// Don't add slash at the end of the url

const DOMAIN_URL = "https://ezzyrock.com";
...
const FIREBASE_SERVER_CLIENT_ID = '589558860804-4opn4ov58i927s1buneptfkg1p597e0f.apps.googleusercontent.com';

/// You can change this to your Provider App package name
/// This will be used in Registered As Partner in Sign In Screen where your users can redirect to the Play/App Store for Provider App
/// You can specify in Admin Panel, These will be used if you don't specify in Admin Panel
const PROVIDER_PACKAGE_NAME = 'com.ezzyrockpartner.nf';
...
const TERMS_CONDITION_URL = 'https://ezzyrock.com/term-conditions';
const PRIVACY_POLICY_URL = 'https://ezzyrock.com/privacy-policy';
const HELP_AND_SUPPORT_URL = 'https://ezzyrock.com/help-support';
const REFUND_POLICY_URL = 'https://ezzyrock.com/refund-policy';
const INQUIRY_SUPPORT_EMAIL = 'support@ezzyrock.com';

/// You can add help line number here for contact. It's demo number
const HELP_LINE_NUMBER = '+919889523524';
